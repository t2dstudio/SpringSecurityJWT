package com.t2dstudio.springsecure.api;
...
public class UserResource {
	...
	public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		if(authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
			try {
				String refresh_token = authorizationHeader.substring("Bearer ".length());//this is to be able to remove the bearer and space so we can pass out token
...
//create an inner class that can take username and role
